---
source_file: iphone-shape-v4.js
category: consumer-product
type: annotated_code
use_case: demonstration of squircle (superellipse) corner construction and smooth spline curve techniques for phone-shaped outlines
related: loft-examples.md, knob8.md
---
# iPhone Shape v4 — Squircle Corner Demonstration

## Description
Demonstrates three different approaches to constructing rounded-rectangle outlines in replicad: a mathematically accurate squircle built from Bézier curves, a standard rounded rectangle, and a smooth spline approximation. All three are extruded into slabs for visual comparison of the curve quality.

## Keywords
squircle, superellipse, bezierCurveTo, smoothSpline, drawRoundedRectangle, iPhone, tangent-chain, mirror, fuse, stretch, sketchOnPlane, extrude, fillet, replicad, curve-comparison, 3d-printing

## Parameters
| Variable | Value | Unit | Meaning |
|----------|-------|------|---------|
| length | 146.7 | mm | iPhone body length |
| width | 71.5 | mm | iPhone body width |
| radius | 20 | mm | Corner radius for squircle construction |
| thickness | 7.4 | mm | Extrusion thickness of the phone slab |
| roundedRect radius | radius × 0.55 = 11 | mm | Rounded rectangle approximation corner radius |
| smoothSpline offset | 10 | mm | Size of smooth spline loop |
| smoothSpline factor f | 2.58 | — | Tangent weight factor controlling spline smoothness |
| roundedRect Z offset | 8 | mm | Vertical offset of rounded rectangle slab |
| smoothSpline extrude | 9 | mm | Extrusion height of spline slab |
